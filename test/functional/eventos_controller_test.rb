...
class EventosControllerTest < ActionController::TestCase
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post :create, evento: { descripcion: @evento.descripcion, fecha: @evento.fecha, precio: @evento.precio, ubicacion: @evento.ubicacion }
    end
  ...
  test "should update evento" do
    put :update, id: @evento, evento: { descripcion: @evento.descripcion, fecha: @evento.fecha, precio: @evento.precio, ubicacion: @evento.ubicacion }
    assert_redirected_to evento_path(assigns(:evento))
  end
